...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let object1 = addin_lib.new_addin("Class1")?;

    let value = Variant::new_i32(321);
    ...
    let value = Variant::new_str(&str1c);
    ...
    let mut params = [
        Variant::new_str(str1c!("11")),
        Variant::new_str(str1c!("22")),
        Variant::new_str(str1c!("33")),
    ];
